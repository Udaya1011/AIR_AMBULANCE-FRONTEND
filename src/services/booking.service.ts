...
export const BookingService = {
    ...
    async update(id: string, payload: any): Promise<Booking> {
        ...
        if (payload.patientId) backendPayload.patient_id = payload.patientId;
        if (payload.originHospitalId) backendPayload.origin_hospital_id = payload.originHospitalId;
        if (payload.destinationHospitalId) backendPayload.destination_hospital_id = payload.destinationHospitalId;
